...
def obds2_reduce(bf, var,Terms,remove_f,remove_v):
      cut_tree = []
        ...
        for v in range(len(winetest)):
            ...
            for cc in range(0, Terms, 4):
                ...
                for d in range(0, trees - 1):
                    ...
                    result = Evaluate_Boolean .evaluate_boolean_function(new_lst1, variable_dict)
