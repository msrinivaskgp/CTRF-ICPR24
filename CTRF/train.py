...
def tree_table(wine_list1, sublist_size):
 ...
 ############################################### MIN LEAF #####################################
    ...
    for i in range(buff2):
            dict  =  basic_functions.class_counts(tree_node[i])
...
df = pandas.read_csv('CTRF/TrainingFiles/bank.csv')
...
for f in range(times):
    ...
    for train_index, test_index in skf.split(pfeatures, target):
        ...
        dic = basic_functions.class_counts(wine)
        dic1 = basic_functions.class_counts(winetest)
    #     print(dic)
    #     print(dic1)
    ...
    # Save the result to a file
        if(k_count == 1):
          with open('CTRF/Output/dt1.pickle', 'wb') as file:
              pickle.dump(dt, file)
          with open('CTRF/Output/test1.pickle', 'wb') as file:
              pickle.dump(winetest, file)
          with open('CTRF/Output/train1.pickle', 'wb') as file:
              pickle.dump(wine, file)
        elif(k_count == 2):
          with open('CTRF/Output/dt2.pickle', 'wb') as file:
              pickle.dump(dt, file)
          with open('CTRF/Output/test2.pickle', 'wb') as file:
              pickle.dump(winetest, file)
          with open('CTRF/Output/train2.pickle', 'wb') as file:
              pickle.dump(wine, file)
        elif(k_count == 3):
          with open('CTRF/Output/dt3.pickle', 'wb') as file:
              pickle.dump(dt, file)
          with open('CTRF/Output/test3.pickle', 'wb') as file:
              pickle.dump(winetest, file)
          with open('CTRF/Output/train3.pickle', 'wb') as file:
              pickle.dump(wine, file)
        elif(k_count == 4):
          with open('CTRF/Output/dt4.pickle', 'wb') as file:
              pickle.dump(dt, file)
          with open('CTRF/Output/test4.pickle', 'wb') as file:
              pickle.dump(winetest, file)
          with open('CTRF/Output/train4.pickle', 'wb') as file:
              pickle.dump(wine, file)
        else:
          with open('CTRF/Output/dt5.pickle', 'wb') as file:
              pickle.dump(dt, file)
          with open('CTRF/Output/test5.pickle', 'wb') as file:
              pickle.dump(winetest, file)
          with open('CTRF/Output/train5.pickle', 'wb') as file:
              pickle.dump(wine, file)
...
with open('CTRF/Output/dt1.pickle', 'rb') as file:
    dt = pickle.load(file)
bf5 = []
...
with open('CTRF/Output/bf1.pickle', 'wb') as file:
        pickle.dump(bf, file)
...
while True:
    ...
    mt= obds1_gmm(dt,bf,pfeatures)
    [bf, cut_tree, remove_f1, remove_v1] = obds2_reduce(mt, 1, Terms,remove_f1,remove_v1)
    ...
    if len(unique_list_tree) == 0:
        break
with open('CTRF/Output/eo1.pickle', 'wb') as file:
        pickle.dump(mt, file)

with open('CTRF/Output/dt2.pickle', 'rb') as file:
    dt = pickle.load(file)
bf5 = []
for d in range(trees):
    [MinT, MinF, MinV, T] = Minterm_cal.minterm_now(dt[d][0],dt[d][4],dt[d][5],dt[d][7],n_class)
    ...
    bf5.append(sublist)
bf = copy.deepcopy(bf5)
with open('CTRF/Output/bf2.pickle', 'wb') as file:
        pickle.dump(bf, file)
...
while True:
    # code block to be executed
    mt= obds1_gmm(dt,bf,pfeatures)
    [bf, cut_tree, remove_f2, remove_v2] = obds2_reduce(mt, 1, Terms,remove_f2,remove_v2)
    unique_list_tree = list(set(remove_consecutive_duplicates(cut_tree)))
    var_ob2 = var_ob2+len(unique_list_tree)
    if len(unique_list_tree) == 0:
        break
with open('CTRF/Output/eo2.pickle', 'wb') as file:
        pickle.dump(mt, file)

with open('CTRF/Output/dt3.pickle', 'rb') as file:
    dt = pickle.load(file)
bf5 = []
for d in range(trees):
    [MinT, MinF, MinV, T] = Minterm_cal.minterm_now(dt[d][0],dt[d][4],dt[d][5],dt[d][7],n_class)
    ...
    bf5.append(sublist)
bf = copy.deepcopy(bf5)
with open('CTRF/Output/bf3.pickle', 'wb') as file:
        pickle.dump(bf, file)
...
while True:
    # code block to be executed
    mt= obds1_gmm(dt,bf,pfeatures)
    [bf, cut_tree, remove_f3, remove_v3] = obds2_reduce(mt, 1, Terms,remove_f3,remove_v3)
    unique_list_tree = list(set(remove_consecutive_duplicates(cut_tree)))
    var_ob3 = var_ob3+len(unique_list_tree)
    if len(unique_list_tree) == 0:
        break
with open('CTRF/Output/eo3.pickle', 'wb') as file:
        pickle.dump(mt, file)

with open('CTRF/Output/dt4.pickle', 'rb') as file:
    dt = pickle.load(file)
bf5 = []
for d in range(trees):
    [MinT, MinF, MinV, T] = Minterm_cal.minterm_now(dt[d][0],dt[d][4],dt[d][5],dt[d][7],n_class)
    ...
    bf5.append(sublist)
bf = copy.deepcopy(bf5)
with open('CTRF/Output/bf4.pickle', 'wb') as file:
        pickle.dump(bf, file)
...
while True:
    # code block to be executed
    mt= obds1_gmm(dt,bf,pfeatures)
    [bf, cut_tree, remove_f4, remove_v4] = obds2_reduce(mt, 1, Terms,remove_f4,remove_v4)
    unique_list_tree = list(set(remove_consecutive_duplicates(cut_tree)))
    var_ob4 = var_ob4+len(unique_list_tree)
    if len(unique_list_tree) == 0:
        break
with open('CTRF/Output/eo4.pickle', 'wb') as file:
        pickle.dump(mt, file)
...
for d in range(trees):
    ...
    bf5.append(sublist)
bf = copy.deepcopy(bf5)
with open('CTRF/Output/bf5.pickle', 'wb') as file:
        pickle.dump(bf, file)
...
while True:
    # code block to be executed
    mt= obds1_gmm(dt,bf,pfeatures)
    [bf, cut_tree, remove_f5, remove_v5] = obds2_reduce(mt, 1, Terms,remove_f5,remove_v5)
    unique_list_tree = list(set(remove_consecutive_duplicates(cut_tree)))
    var_ob5 = var_ob5+len(unique_list_tree)
    if len(unique_list_tree) == 0:
        break
with open('CTRF/Output/eo5.pickle', 'wb') as file:
        pickle.dump(mt, file)

#print(len(remove_f1),len(remove_f2),len(remove_f3),len(remove_f4),len(remove_f5))

print('fold_1_ feature_wise',basic_functions.count_unique_elements(remove_f1))
print('fold_2_feature_ wise',basic_functions.count_unique_elements(remove_f2))
print('fold_3_feature_wise',basic_functions.count_unique_elements(remove_f3))
print('fold_4_feature_wise',basic_functions.count_unique_elements(remove_f4))
print('fold_5_feature_wise',basic_functions.count_unique_elements(remove_f5))
